...
class EpubChapter:
    def __init__(self, dir_path, title, start: str = None):
        ...
        self.title = title
        self.children: List[EpubChapter] = []
        self._start = start
...
class EPubMaker(threading.Thread):
    def __init__(
        ...
        self.page_turn_style = page_turn_style
        self.picture_at = 1
        ...
        self.cover = None
        self.chapter_tree: Optional[EpubChapter] = None
        self.images = []
    ...
    def make_tree(self):
        root = Path(self.dir)
        self.chapter_tree = EpubChapter(root.parent, None)
        ...
        for dir_path, dir_names, filenames in os.walk(self.dir):
            ...
            chapter = EpubChapter(
                dir_path, dir_path.name, images[0] if images else None
            )
    ...
    def write_template(self, name, *, out=None, data=None):
        ...
        data = data or {
            ...
            "page_turn_style": self.page_turn_style,
